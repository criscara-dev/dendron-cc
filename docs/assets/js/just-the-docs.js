(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://criscara-dev.github.io/digital-garden/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://criscara-dev.github.io/digital-garden/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://criscara-dev.github.io/digital-garden/assets/css/just-the-docs-' + theme + ".css"
      );
    };
