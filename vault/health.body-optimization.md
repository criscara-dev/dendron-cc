...
## Andrew Huberman Series on YouTube

2021-03-22 18:50
### How Your Nervous System Works & Changes

- nervous system: brain + spinal chord
- memory: pattern of electricity and neurons
- attention can be under control when we're rested
- neuron release chemicals with profound effects on our emotional state (*neuro modulators such as dopamine, seratonine, acetylcholine, epinefrine) they bias which neurons are going to be active
- thoughts: allow reach into the past and anticipate the future that allow us engsge in things that are not only for the moment...
- deliberate practice consist of 3 things: duration of the event, path and outcome
- impulsivity is a lack of top-down control, of top-down processing that develop as well with age sometime not till 20 or more y.o.(it take down the fore brain),like alcohol
- when you're shaking because you're angry is your lymbic system, the frontal cortex is in conflict with it.
- neuroplasticity(ability to change the nervous system): you wanna know how to shape your behaviour
- neuroplasticity:
    - positive (adaptive) and self directed: how can I engage neuroplasticity?
    the key to answer is understanding how awake or asleepy we are.
    We can decide we can change our brain and the brain can change itself
    Neuroplasticity is more difficult in adults that's why kids can learn more language without an accent.
    In adults, neuroplasticity is regulated by gatekeepers: *neuromodulators (see above)
...
- nerve vague (transcranial nerve) and stimulation of relaxment
- gut has sensors that sense... like sugar!, aka the gut feeling!
- ex if I put sugar into a salty food...my body will sense it and without know that I'll crave for more of that food (just because it has sugar!)
- rewards/predictions error and dopamine; amino acids in the gut detect which amino acids and L-tyrosine...that make dopamine. 
L-tyrosine Increase mood but as well brain fog. 
seratonine ...
...
- red lights for a few minutes in the morning to optimize cell mythocondria via effect on photoreceptors in back of the retina... help repare them!
- circadian clock look for a lot of light in the morning to increase alertness
- watch sun light in the evening
- longer days (summer) melatonin less
- performance are optimize and injury reduced, when? (even in terms of STUDYING!)
    - 30' after waking up, 3 hrs after waking (rise of the body temperature), and 11 hrs after waking. basically when the temperature tend to peak
    - this means if I wake up at 7 am: 7:30, 10 am, 18:30
    - cycle learning is 90': start - focus - deep focus - tired
    - 20' naps/light non sleep/deep rest close after last read sentence/study
    it has been proven to accelerate learning to a significant degree, in terms of amount of info and retention of info (drug free boost)
- hypnosis can help... research more in AH video
- Nootropics: Magnesium-L-Threonate to get asleep, Modafinil...
- temperature in sleep:
    - ref. [Joseph_Takahashi](https://en.wikipedia.org/wiki/Joseph_Takahashi) and [Abstract](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3756146/)
    - how to use cold to enhance energy/moods:
